...
> Contributor reference. For the provider-agnostic sync loop (flow, file
> writing, Markdown format), see [sync.md](sync.md).
...
See [sync.md](sync.md) for the shared sync flow, file writing, and Markdown format that all three providers feed into.
